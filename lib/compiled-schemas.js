...
const _errs25 = errors;
if(typeof data.allErrors !== "boolean"){
validate10.errors = [{instancePath:instancePath+"/allErrors",schemaPath:"#/properties/allErrors/type",keyword:"type",params:{type: "boolean"},message:"must be boolean"}];
return false;
}
var valid0 = _errs25 === errors;
}
...
if(!(validate24(data11[i1], {instancePath:instancePath+"/links/" + i1,parentData:data11,parentDataProperty:i1,rootData}))){
vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
errors = vErrors.length;
}
...
if(!(((((data16 === "debug") || (data16 === "info")) || (data16 === "warn")) || (data16 === "error")) || (data16 === "silent"))){
